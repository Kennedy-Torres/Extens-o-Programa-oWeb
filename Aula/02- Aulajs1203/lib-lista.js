...
function mostrarResultado(soma) {
    const resultadoDiv = document.getElementById("resultado"); // a linha em si é responsável apenas por obter uma referência a esse elemento para posterior manipulação.
